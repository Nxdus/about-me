import { ArrowBigUpIcon, GithubIcon, InstagramIcon, MailIcon, Twitter, TwitterIcon, X } from "lucide-react";
  ...
  return (
    <main className="h-dvh grid grid-cols-5 grid-rows-3 gap-5 justify-center bg-[#F9F7F0] select-none px-20 py-5">
      ...
      <article className="row-span-2 row-start-2 bg-[#FFBB4E] rounded-4xl flex justify-center items-center gap-8 flex-col relative">
        ...
        <button className="uppercase text-[#4A4947] text-4xl/tight px-10 py-0.5 pb-2 bg-[#F9F7F0] text-center rounded-full border-3 border-dashed">Read</button>
      </article>
      <article className="col-span-3 row-start-2 bg-[#FD5A46] rounded-4xl relative">
        ...
        <button className="absolute bottom-8 right-18 uppercase text-[#4A4947] text-4xl/tight px-10 py-0.5 pb-2 bg-[#F9F7F0] text-center rounded-full border-3 border-dashed">Hire me</button>
      </article>
